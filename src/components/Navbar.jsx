...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile menu */}
      <div className={`fixed inset-x-0 top-[57px] z-40 nav-glass border-t border-card transition-all duration-300 md:hidden ${menuOpen ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 -translate-y-2 pointer-events-none'}`}>
